        ...
        <section className='py-6 sm:py-8 md:py-10 lg:py-14 px-4 md:px-6'>
            <main className='flex flex-col items-center w-full'>
                ...
                <div className="flex gap-4 items-center mt-10 ">
                    <h3 className='text-2xl font-bold font-header'>Tools & Technologies:</h3>
                    <main className='grid grid-cols-3 lg:grid-cols-5 gap-y-5  gap-2 items-center '>
                        {tools.map((tool,index) => (
                            <div key={index} className="flex items-center justify-center  gap-2 p-4 h-32 rounded-md flex-col ring-1 ring-accent hover:bg-accent duration-500 ">
