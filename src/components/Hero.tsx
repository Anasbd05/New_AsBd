...
const Hero = () => {
    return (
        <section className='py-5 w-11/12 h-screen flex items-center justify-center lg:h-[700px] mt-4 mx-auto'>
            <main className='flex flex-col lg:flex-row w-full justify-between h-full items-center'>
                <div className="flex flex-col gap-4 z-40 w-full mt-20 lg:mt-0 lg:w-2/5">
                ...
                <div className=" w-full lg:w-3/5 relative ">
                    <Image src={"/hero.png"} alt='' className='w-full absolute h-[500px] object-cover bottom-50 lg:-top-65  ' width={700} height={800} />
                </div>
